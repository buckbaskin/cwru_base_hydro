...
(cl:defmethod cl:initialize-instance :after ((m <Sonar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sonar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_base-msg:<Sonar> is deprecated: use cwru_base-msg:Sonar instead.")))
...
(cl:defmethod dist-val ((m <Sonar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:dist-val is deprecated.  Use cwru_base-msg:dist instead.")
  (dist m))
