...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_base-msg:<Pose> is deprecated: use cwru_base-msg:Pose instead.")))
...
(cl:defmethod x-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:x-val is deprecated.  Use cwru_base-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:y-val is deprecated.  Use cwru_base-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:theta-val is deprecated.  Use cwru_base-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:vel-val is deprecated.  Use cwru_base-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'omega-val :lambda-list '(m))
(cl:defmethod omega-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:omega-val is deprecated.  Use cwru_base-msg:omega instead.")
  (omega m))

(cl:ensure-generic-function 'x_var-val :lambda-list '(m))
(cl:defmethod x_var-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:x_var-val is deprecated.  Use cwru_base-msg:x_var instead.")
  (x_var m))

(cl:ensure-generic-function 'y_var-val :lambda-list '(m))
(cl:defmethod y_var-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:y_var-val is deprecated.  Use cwru_base-msg:y_var instead.")
  (y_var m))

(cl:ensure-generic-function 'theta_var-val :lambda-list '(m))
(cl:defmethod theta_var-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:theta_var-val is deprecated.  Use cwru_base-msg:theta_var instead.")
  (theta_var m))

(cl:ensure-generic-function 'vel_var-val :lambda-list '(m))
(cl:defmethod vel_var-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:vel_var-val is deprecated.  Use cwru_base-msg:vel_var instead.")
  (vel_var m))

(cl:ensure-generic-function 'omega_var-val :lambda-list '(m))
(cl:defmethod omega_var-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:omega_var-val is deprecated.  Use cwru_base-msg:omega_var instead.")
  (omega_var m))
