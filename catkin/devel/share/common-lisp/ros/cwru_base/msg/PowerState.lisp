...
(cl:defmethod cl:initialize-instance :after ((m <PowerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_base-msg:<PowerState> is deprecated: use cwru_base-msg:PowerState instead.")))
...
(cl:defmethod battery_voltage-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:battery_voltage-val is deprecated.  Use cwru_base-msg:battery_voltage instead.")
  (battery_voltage m))

(cl:ensure-generic-function 'cRIO_voltage-val :lambda-list '(m))
(cl:defmethod cRIO_voltage-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:cRIO_voltage-val is deprecated.  Use cwru_base-msg:cRIO_voltage instead.")
  (cRIO_voltage m))

(cl:ensure-generic-function 'v13_8_voltage-val :lambda-list '(m))
(cl:defmethod v13_8_voltage-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:v13_8_voltage-val is deprecated.  Use cwru_base-msg:v13_8_voltage instead.")
  (v13_8_voltage m))

(cl:ensure-generic-function 'motor_voltage-val :lambda-list '(m))
(cl:defmethod motor_voltage-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:motor_voltage-val is deprecated.  Use cwru_base-msg:motor_voltage instead.")
  (motor_voltage m))
