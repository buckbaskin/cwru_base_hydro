...
(cl:defmethod cl:initialize-instance :after ((m <NavSatStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavSatStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_base-msg:<NavSatStatus> is deprecated: use cwru_base-msg:NavSatStatus instead.")))
...
(cl:defmethod service-val ((m <NavSatStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_base-msg:service-val is deprecated.  Use cwru_base-msg:service instead.")
  (service m))
